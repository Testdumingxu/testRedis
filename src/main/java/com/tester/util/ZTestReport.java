...
public class ZTestReport implements IReporter {
    ...
    // 报告路径
    private String report_path = path + "test_redis\\src\\main\\java\\com\\tester\\report\\" + "report.html";
    // 报告模板路径
    private String template_path = path + "test_redis\\src\\main\\java\\com\\tester\\report\\" + "template";
    //源代码先注释掉
...
//			String template = this.read(templatePath);
            String template = this.read(template_path);
